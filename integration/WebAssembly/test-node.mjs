...
//  re-INIT after DEINIT must pass the self-test again
//  (regression: drbg_self_test refused to run on a live DRBG and the refusal
//  was reported as SELF_TEST_FAIL)
await uapkiOk("INIT", {
    cmProviders: { dir: "", allowedProviders: [ { lib: "cm-pkcs12" } ] },
    certCache: { path: "/certs/", trustedCerts: [] },
    crlCache: { path: "/crls/" },
